        			...
        			<form class="reservation_form row" action="PlanController" method="post" id="contactForm" novalidate="novalidate">
					   ...
					   <div class="col-xl-12">
						...
						<div class=" col-xl-12">
							...
							value="<%=p.getNoofguest()%>">
						</div>
						<div class="col-xl-12">
							<input type="text" name="venue" value="<%=p.getVenue()%>">
						</div>
						<div class="col-xl-12">
						    <input type="text" name="photovideos"value="<%=p.getPhotovideos()%>">
						</div>
						<div class="col-xl-12">
							<input type="text" name="noofguestfortransport"
							value="<%=p.getNoofguestfortransport()%>">
						</div>
						<div class="col-xl-12">
							<button type="submit" name="action" value="update plan"
