							...
							<ul class="nav navbar-nav menu_nav ml-auto">
								...
								<li class="nav-item submenu dropdown">
									...
									<ul class="dropdown-menu">
										<li class="nav-item"><a class="nav-link" href="w-register.jsp">As Wedding Planner</a></li>
										<li class="nav-item"><a class="nav-link" href="c-register.jsp">As Customer</a></li>
								...
								<li class="nav-item submenu dropdown">
									...
									<ul class="dropdown-menu">
										<li class="nav-item"><a class="nav-link" href="w-login.jsp">As Wedding Planner</a></li>
										<li class="nav-item"><a class="nav-link" href="c-login.jsp">As Customer</a></li>
										<li class="nav-item"><a class="nav-link" href="admin-login.jsp">As Admin</a></li>
									</ul>
								</li> 
